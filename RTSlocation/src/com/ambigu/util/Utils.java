...
public class Utils {
	...
	public void selectPicture(Activity activity) {
		if (Build.VERSION.SDK_INT < 19) {
			...
			activity.startActivityForResult(intent, ApplicationVar.KITKAT_LESS);
		} else {
			Intent intent = new Intent();
			intent.setType("image/*");
			...
			activity.startActivityForResult(intent, ApplicationVar.KITKAT_ABOVE);
		}
	}
	...
	public void cropPicture(Activity activity, Uri uri) {
		...
		activity.startActivityForResult(innerIntent, ApplicationVar.INTENT_CROP);
	}
	...
	public static void clearSharingState(Context context){
		Intent broadCastIntent = new Intent("com.ambigu.rtslocation.RealTimeSharing");
		broadCastIntent.putExtra("clearSharingState", true);
