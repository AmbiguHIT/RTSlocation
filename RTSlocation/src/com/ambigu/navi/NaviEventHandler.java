...
public class NaviEventHandler {
	...
	private NaviEventDialog mEventDialog = null;

	private static class LazyLoader {
		private static NaviEventHandler mInstance = new NaviEventHandler();
	}
	...
	public NaviEventDialog getDialog(Context ctx) {
		if (mEventDialog == null) {
			mEventDialog = new NaviEventDialog(ctx);
		}
		return mEventDialog;
	}
	...
	public void handleNaviEvent(int what, int arg1, int arg2, Bundle bundle) {
		Log.i("onCommonEventCall",
				String.format("%d,%d,%d,%s", what, arg1, arg2, (bundle == null ? "" : bundle.toString())));
		switch (what) {
