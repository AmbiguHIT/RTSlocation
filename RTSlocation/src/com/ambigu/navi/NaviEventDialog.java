...
public class NaviEventDialog extends Dialog {
	...
	private TextView mRemainDistanceTx; // ʣ���ܾ���
	...
	public NaviEventDialog(Context context) {
		super(context);
		mContext = context;
	}
	...
	public void updateLocateState(boolean hasLocate) {
		if (mLocateTx != null) {
			mLocateTx.setText(hasLocate ? "��λ�ɹ�" : "��λ��");
		}
	}
